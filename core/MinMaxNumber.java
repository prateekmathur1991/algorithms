...
public class MinMaxNumber	{
	public static void main(String [] args)	{
		...
		int comps = 0; // I use this 'comps' variable for the sole purpose of counting comparisions
		...
		System.out.println("Got maximum number:: " + max + " Got minimum number:: " + min + " comparisions used:: " + comps);
	}
}
