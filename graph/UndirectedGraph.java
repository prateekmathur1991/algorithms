...
public class UndirectedGraph {
		...
		while (queue.size() != 0) {
			...
			while (itr1.hasNext()) {
				...
				if ("w".equals(v.color)) {
					...
					v.parent = u;
					System.out.println("Processed neighbour. Name:: " + v.name + " Distance:: " + v.distance
							+ " Parent:: " + u.name);
					queue.add(v);
				}
			}
	...
	private void dfsVisit(Vertex u, boolean topo) {
		...
		System.out.println("Visit complete for " + u.name + " First Visit Time:: " + u.discoveryTime
				+ " Last Visit Time:: " + u.finishTime);
